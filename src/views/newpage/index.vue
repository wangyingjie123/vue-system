  ...
  export default {
    ...
    mounted() {
      ...
      setTimeout(function() {
        that.someList = [
          {
            html: '<img src="./static/img/1.jpg" alt="01">'
          },
          {
            html: '<img src="static/img/2.jpg" alt="02">'
          },
          {
            html: '<img src="static/img/3.jpg" alt="03">'
          },
          {
            html: '<img src="static/img/4.jpg" alt="04">'
          },
          {
            html: '<img src="static/img/5.jpg" alt="05">'
          },
          {
            html: '<img src="static/img/6.jpg" alt="06">'
          },
          {
            html: '<img src="static/img/7.jpg" alt="07">'
          }
        ]
      }, 2000)
    },
